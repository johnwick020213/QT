...
QT_INIT_METAOBJECT const QMetaObject B::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_B.data,
    qt_meta_data_B,
    qt_static_metacall,
    nullptr,
    nullptr
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_C_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_C_t qt_meta_stringdata_C = {
    {
QT_MOC_LITERAL(0, 0, 1) // "C"
...
QT_INIT_METAOBJECT const QMetaObject C::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_C.data,
    qt_meta_data_C,
    qt_static_metacall,
    nullptr,
    nullptr
